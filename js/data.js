...
// Mutable Zones object (Global)
// Mutable Zones object (Global)
window.ZONES = JSON.parse(JSON.stringify(ZONES_DEF));
window.state = {};
...
const STATIONS = [
    ...
    { id: 'laan_noi', name: 'Laan v NOI', x: 0.40, y: 0.09, zone: 'randstad' },
    ...
    { id: 'rodenrijs', name: 'Rodenrijs', x: 0.61, y: 0.30, zone: 'randstad' },
    ...
    { id: 'delfshaven', name: 'Delfshaven', x: 0.50, y: 0.49, zone: 'west_1' },
    ...
    { id: 'oosterflank', name: 'Oosterflank', x: 0.84, y: 0.40, zone: 'binnenhof' },
    ...
    { id: 'nieuw_verlaat', name: 'Nw. Verlaat', x: 0.90, y: 0.27, zone: 'nesselande' },
    ...
    { id: 'troelstra', name: 'Troelstralaan', x: 0.41, y: 0.60, zone: 'west_2' },
...
// OFFICIAL RET LINE COLORS & ROUTES
const ROUTES_DEF = [
    {
        id: 'A', name: 'Lijn A (Binnenhof)', color: '#009E4D', offset: -4, // Green
        path: [
            'schiedam_c',
            'marconi', 'delfshaven', 'coolhaven', 'dijkzigt', 'eendracht', 'beurs', 'blaak',
            'oostplein', 'gerdesia', 'voorschoter', 'kralingse', 'capelse', 'schenkel', 'prinsenlaan',
            'oosterflank', 'alexander', 'graskruid', 'wp_graskruid_split', 'romeynshof', 'binnenhof'
        ]
    },
    {
        id: 'B', name: 'Lijn B (Nesselande)', color: '#FFD700', offset: 0, // Yellow
        path: [
            'hvh_strand', 'hvh_haven', 'steendijk', 'maassluis_west', 'maassluis_c', 'wp_maassluis_bend',
            'vlaardingen_west', 'vlaardingen_c', 'vlaardingen_oost', 'schiedam_nieuw', 'schiedam_c',
            'marconi', 'delfshaven', 'coolhaven', 'dijkzigt', 'eendracht', 'beurs', 'blaak',
            'oostplein', 'gerdesia', 'voorschoter', 'kralingse', 'capelse', 'schenkel', 'prinsenlaan',
            'oosterflank', 'alexander', 'graskruid', 'wp_graskruid_split', 'hesseplaats', 'nieuw_verlaat', 'ambachtsland',
    ...
    },
    {
        ...
        path: [
            'de_akkers', 'heemraad', 'spijkenisse_c', 'zalmplaat', 'hoogvliet', 'tussenwater', 'wp_join',
            'pernis', 'vijfsluizen', 'troelstra', 'parkweg', 'wp_schiedam_turn', 'schiedam_c',
            'marconi', 'delfshaven', 'coolhaven', 'dijkzigt', 'eendracht', 'beurs', 'blaak',
            'oostplein', 'gerdesia', 'voorschoter', 'kralingse', 'capelse', 'slotlaan', 'capelle_c', 'de_terp'
        ]
    },
    {
        id: 'D', name: 'Lijn D (De Akkers)', color: '#00A1DE', offset: -3, // Light Blue
        path: [
            'cs', 'stadhuis', 'beurs', 'leuvehaven', 'wilhelmina', 'rijnhaven', 'maashaven',
            'zuidplein', 'slinge', 'wp_slinge_bend', 'rhoon', 'poortugaal', 'wp_join', 'tussenwater', 'hoogvliet', 'zalmplaat',
            'spijkenisse_c', 'heemraad', 'de_akkers'
        ]
    },
    {
        id: 'E', name: 'Lijn E (Slinge)', color: '#003D86', offset: 3, // Dark Blue
        path: [
            'den_haag', 'laan_noi', 'voorburg_loo', 'leidschendam', 'forepark', 'leidschenveen',
            'nootdorp', 'pijnacker_c', 'pijnacker_z', 'berkel', 'rodenrijs', 'meijersplein',
            'melanchthon', 'blijdorp', 'cs', 'stadhuis', 'beurs', 'leuvehaven', 'wilhelmina',
            'rijnhaven', 'maashaven', 'zuidplein', 'slinge'
        ]
    }
];
